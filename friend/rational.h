...
public://open to everyone 
    ...
    //friend: special functions which are not member of a class but can access private parts
    //trusted outsiders 
...
private://for internal use only, only the class itself can use private members 
    //reason to use private: hide complicated details, prevent accidental misuse of the class
